...
if($key !="")
{
    $where .= " AND (title like '%{$key}%' OR description like '%{$key}%')";
}
$docs_list = get_all_docs($where);
?>
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1>Manage Document <small>Control Panel</small></h1>
        <ol class="breadcrumb">
          <li><a href="dashboard.php"><i class="icon-dashboard"></i> Dashboard</a></li>
          <li class="active"><i class="icon-file-alt"></i> Manage Documents</li>
        </ol>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped tablesorter">
              ...
              <?php
                ...
                while($row = mysqli_fetch_assoc($docs_list)) {
              ...
              ?>
                  ...
                  <div class="modal fade" id="confirm-delete-modal<?php echo htmlentities($row['doc_id']); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="delete-document.php?doc_id=<?php echo htmlentities($row['doc_id']); ?>" class="btn btn-primary">Yes</a>
                        </div>
                      </div>
                    </div>
                  </div><!-- /.modal fade -->
